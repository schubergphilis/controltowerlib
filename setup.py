...
setup(
    ...
    version=version,
    description='''A library to provide access to AWS service catalog provided by Control Tower and basic functionality with interfacing with it.''',
    long_description=readme + '\n\n' + history,
    author='''Costas Tyfoxylos''',
    author_email='''ctyfoxylos@schubergphilis.com''',
    url='''https://github.com/schubergphilis/controltowerlib.git''',
